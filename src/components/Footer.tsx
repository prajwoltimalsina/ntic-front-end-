        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            ...
            <div className="text-gray-400 text-sm space-y-2">
              <p className="hover:text-indigo-400 transition-colors">Dhulikhel, Kavre, Nepal</p>
              <p className="hover:text-indigo-400 transition-colors">+977-9820114518</p>
              <p className="hover:text-indigo-400 transition-colors">ntic@ku.edu.np</p>
            </div>
          </div>
        </div>
